...
//            System.out.print(col + ", " + row + " = ");
    ...
    public void setTextLblJugador(String lblJugador) {
        this.lblJugador.setText(lblJugador);
    }
    
    public void setTextMovimientos(String[] jugada){
        String agregar = this.txtMovimientos.getText() + "\n" + jugada[0] + " - " + jugada[1];
        this.txtMovimientos.setText(agregar);
    }
